...
%-------------------------------------------------------------------------%
        ...
        x1 = xhat+delta*ut; % learner's action in bandit case
        x2 = xhat-delta*ut;
...
%-------------------------------------------------------------------------%
        ...
        for n = 1:N
            ...
            grad_znhat = d/(2*delta)*(latency1-latency2)*uznhat;
            grad_ynkhat1 = d/(2*delta)*(latency1-latency2)*uynkhat(1,1);
            grad_ynkhat2 = d/(2*delta)*(latency1-latency2)*uynkhat(2,1);
            grad_ynnhat = d/(2*delta)*(latency1-latency2)*uynnhat;
